...
var fs = require('fs')
var logger = fs.createWriteStream('report-RBra22.txt', {
...
function BOMBA(tweet) {
	...
	if ( tweet.user.screen_name !== 'RBra22' ) {
